...
$articles = $bdd->query('SELECT * FROM produit ORDER BY numero DESC');
if(isset($_GET['recherche']) AND !empty($_GET['recherche'])) {
   $recherche= htmlspecialchars($_GET['recherche']);
   $articles = $bdd->query('SELECT * FROM produit WHERE category LIKE "%'.$recherche.'%" ORDER BY numero DESC');
}
?>
                                    ...
                                    <div class="col-lg-6 col-md-6 col-sm-6 col-xs-6">
                                        <div class="breadcome-heading">
                                            <form role="search" class="">
                                                <input type="text" placeholder="Search..." class="form-control" name="recherche" >
    ...
    ?>
                                <tr>
                                    ...
                                    <td>
                                        ...
                                        <a href="?action=delete&amp;num=<?php echo $s->numero; ?>"><button data-toggle="tooltip" title="Trash" class="pd-setting-ed"><i class="fa fa-trash-o" aria-hidden="true"></i></button></a>
                                    </td>
                                </tr>
   <?php } ?>
<?php } else { ?>
