...
<body>
    ...
    <!-- start add category
        ============================================ --> 
<form id="regForm"  method="POST" action="ajoutercategory.php" enctype="multipart/form-data">
  <h1>Create Your Menu:</h1>
  <!-- One "tab" for each step in the form: -->
  <div class="tab">Category:
    <p><input placeholder="Add Category..." oninput="this.className = ''" name="category"></p>
  </div>
  <div class="tab">Add Sub Menu to your Category:
    <div class="container">  
                     <form name="add_name" id="add_name">  
                               <table  id="dynamic_field" style="width:80%">  
                                    <tr>  
                                         <td><input type="text" name="name[]" placeholder="Add sub menu..." /></td>  
                                         <td><button type="button" name="add" id="add" class="btn btn-success">Add More</button></td>  
                                         <td><input type="submit" name="submit" value="ajouter category"></td>
                                    </tr>  
                               </table>     
                     </form>   
           </div>  
...
<script>  
 $(document).ready(function(){  
      ...
      $('#add').click(function(){  
           i++;  
           $('#dynamic_field').append('<tr id="row'+i+'"><td><input type="text" name="name[]" placeholder="Add sub menu..."  /></td><td><button type="button" name="remove" id="'+i+'" class="btn btn-danger btn_remove">X</button></td></tr>');  
      });  
