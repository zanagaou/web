...
<body>
    ...
    <!-- Category List
        ============================================ --> 
<form id="regForm"  method="POST" action="view.php" enctype="multipart/form-data">
  <h1 style="position: relative; left: 400px;top: 100px">Select your category</h1>
  <select name="select" class="form-control pro-edt-select form-control-primary" style="position: relative;left:200px; top:200px; width: 800px;height: 50px" >
                              <option value="opt1">Select Category</option>
                    <?php  foreach($categorie as $cat){ ?>
                              <option value="<?php echo $cat['id']; ?>"><?php echo $cat['category']; ?></option> 
                              <?PHP } ?>
                              </select>
                                <input  type="submit" name="viewcategory" value="View category" style="position: relative;top: 260px;left: 500px;width: 200px;height: 30px">
