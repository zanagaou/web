...
<head>
    ...
    <title>back end baz'art</title>
    <meta name="description" content="">
    <meta name="viewport" content="width=device-width, initial-scale=1">
    <!-- favicon
		============================================ -->
    <link rel="shortcut icon" type="image/x-icon" href="img/bazart.jpg">
    <!-- Google Fonts
		============================================ -->
...
<body>
    ...
    <div class="left-sidebar-pro" > 
        <nav id="sidebar" class="">
            ...
            <div class="logoaffevent" style="padding-left: 638px; background-color: #ffe6ff; padding-top: 8px" >
				<a href="#"><img src="img/bazart.jpg" alt="logo bazart"  style="width : 250px; height: 250px" ></a>
			</div>
                        ...
                        <li class="active">
                            <a class="has-arrow" href="index.html">
                                ...
                                <ul class="submenu-angle" aria-expanded="false">
                                    <li>
                           <a class="has-arrow" href="mailbox.html" aria-expanded="false"><i class="fa big-icon fa-envelope icon-wrap"></i> <span class="mini-click-non">S.A.V</span></a>
                            <ul class="submenu-angle" aria-expanded="false">
                                <li>
                                <a class="has-arrow" href="#" aria-expanded="false"><i class="fa big-icon fa-envelope icon-wrap"></i> <span class="mini-click-non">Gestion Livreur</span></a>
                            <ul class="submenu-angle" aria-expanded="false">
                                <li>
                            
                                

                                <li><a title="Inbox" href="SAV/livreur/views/ajoutLivreur.html"><i class="fa fa-inbox sub-icon-mg" aria-hidden="true"></i> <span class="mini-sub-pro">Ajouter Livreur</span></a></li>
                                <li><a title="View Mail" href="SAV/livreur/views/afficherLivreur.php"><i class="fa fa-television sub-icon-mg" aria-hidden="true"></i> <span class="mini-sub-pro">Parcourir</span></a></li>
                                </li>
                         </li>
                                </li>
       ...
       <ul class="submenu-angle" aria-expanded="false">
                           ...
                           <a class="has-arrow" href="mailbox.html" aria-expanded="false"><img src="img/event-icon.png" width="30" height="30"/> <span class="mini-click-non">Module Evenements</span></a>
                            <ul class="submenu-angle" aria-expanded="false">
                                    <li>

                                     
                                <a class="has-arrow" href="#" aria-expanded="false"><img src="img/gestion-icon.png" width="30" height="30"/> <span class="mini-click-non">Gestion Events</span></a>

                            <ul class="submenu-angle" aria-expanded="false">

                                    <li>
                            
                                <li><a title="Event" href="ajoutEvent.html"><img src="img/plus-icon.png" width="30" height="30"/> <span class="mini-sub-pro">Ajouter Event</span></a></li>
                                <li><a title="Parcourir" href="afficherEvent.php"><img src="img/search-icon.png" width="30" height="30"/> <span class="mini-sub-pro">Parcourir</span></a></li>
                                </li>
                            </ul>
                            ...
                            <ul class="submenu-angle" aria-expanded="false">
                                ...
                                <a class="has-arrow" href="#" aria-expanded="false"><img src="img/gestion-icon.png" width="30" height="30"/> <span class="mini-click-non">Gestion Remise</span></a>

                            <ul class="submenu-angle" aria-expanded="false">
                                <li>
                                <li><a title="Remise" href="product-list.php"><img src="img/plus-icon.png" width="30" height="30"/> <span class="mini-sub-pro">Ajouter Remise</span></a></li>
                                <li><a title="Parcourir" href="afficherRemise.php"><img src="img/search-icon.png" width="30" height="30"/> <span class="mini-sub-pro">Parcourir</span></a></li>
                                </li>
                            </ul>
                           </li>
                       </ul>
                                ...
                                <!--<li><a title="Dashboard v.1" href="index.html"><i class="fa fa-bullseye sub-icon-mg" aria-hidden="false"></i> <span class="mini-sub-pro">Dashboard v.1</span></a></li>
                                <li><a title="Dashboard v.2" href="index-1.html"><i class="fa fa-circle-o sub-icon-mg" aria-hidden="false"></i> <span class="mini-sub-pro">Dashboard v.2</span></a></li>
                                <li><a title="Dashboard v.3" href="index-2.html"><i class="fa fa-cube sub-icon-mg" aria-hidden="false"></i> <span class="mini-sub-pro">Dashboard v.3</span></a></li>
                                <li><a title="Product List" href="product-list.html"><i class="fa fa-female sub-icon-mg" aria-hidden="false"></i> <span class="mini-sub-pro">Product List</span></a></li>
                                <li><a title="Product Edit" href="product-edit.html"><i class="fa fa-bolt sub-icon-mg" aria-hidden="false"></i> <span class="mini-sub-pro">Product Edit</span></a></li>
                                <li><a title="Product Detail" href="product-detail.html"><i class="fa fa-heart-o sub-icon-mg" aria-hidden="false"></i> <span class="mini-sub-pro">Product Detail</span></a></li>
                                <li><a title="Product Cart" href="product-cart.html"><i class="fa fa-level-down sub-icon-mg" aria-hidden="false"></i> <span class="mini-sub-pro">Product Cart</span></a></li>
                                <li><a title="Product Payment" href="product-payment.html"><i class="fa fa-location-arrow sub-icon-mg" aria-hidden="false"></i> <span class="mini-sub-pro">Product Payment</span></a></li>
                                <li><a title="Analytics" href="analytics.html"><i class="fa fa-line-chart sub-icon-mg" aria-hidden="false"></i> <span class="mini-sub-pro">Analytics</span></a></li>
                                <li><a title="Widgets" href="widgets.html"><i class="fa fa-magnet sub-icon-mg" aria-hidden="false"></i> <span class="mini-sub-pro">Widgets</span></a></li>
                            </ul>
                        </li>-->
                   <!--     <li>
